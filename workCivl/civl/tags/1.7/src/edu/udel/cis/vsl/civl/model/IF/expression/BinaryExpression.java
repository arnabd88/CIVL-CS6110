...
public interface BinaryExpression extends Expression {
	...
	public enum BINARY_OPERATOR {
		AND, BITAND, BITOR, BITXOR, DIVIDE, EQUAL, HASH, IMPLIES, LESS_THAN, LESS_THAN_EQUAL, MINUS, MODULO, NOT_EQUAL, OR, PLUS, POINTER_ADD, POINTER_SUBTRACT, SHIFTLEFT, SHIFTRIGHT, TIMES
	};
