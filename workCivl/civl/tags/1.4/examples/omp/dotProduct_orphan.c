...
******************************************************************************/
/**
* This program computes the dot product of two vectors. The parallel loop
* construct is orphaned - it is contained in a subroutine outside the lexical
* extent of the main program's parallel region.
* Online source:
