...
/* This is a model of a process.  It should exhibit the same
 * interface as the real process, where the interface is interpreted
 * to mean the sequence of send/recv events.
 */
void getNextSend(int dest, void *buf, MPI_Datatype *type, int* count);
processRecv(source, message) : void
