/* wildcard_coassert_barrier: A root process receives messages twice
   from every other process using a wildcard receive. Processes are
   forces to synchronize after each iteration. */
#include <mpi.h>
#include <stdio.h>
